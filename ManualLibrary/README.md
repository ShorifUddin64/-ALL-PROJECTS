<div align="center">
  ...
  <h1>📚 Manual Library Management System</h1>
  <p><b>A modern desktop application to streamline traditional library workflows</b></p>

  <p>
    <img src="https://img.shields.io/badge/Language-Java-orange?style=for-the-badge&logo=java" alt="Java" />
    <img src="https://img.shields.io/badge/GUI-Swing%20%26%20AWT-blue?style=for-the-badge" alt="Swing" />
    <img src="https://img.shields.io/badge/Type-Group%20Project-green?style=for-the-badge" alt="Group Project" />
  </p>
...
---
<!DOCTYPE html>
<!-- saved from url=(0079)https://6587eb94-5549-497f-8f88-35c774dd0e29-00-17d6ua1vppgmj.sisko.replit.dev/ -->
...
window.$RefreshSig$ = () => (type) => type;</script>
    ...
    <script type="module" src="./ManualLibrary_files/client"></script>

    
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1">
    <title>ManualLibrary</title>
    <meta name="description" content="ManualLibrary — built on Replit. Update this description to reflect the app.">
    <meta name="robots" content="index, follow">
    <meta property="og:title" content="ManualLibrary">
    <meta property="og:description" content="ManualLibrary — built on Replit. Update this description to reflect the app.">
    <meta property="og:type" content="website">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="ManualLibrary">
    <meta name="twitter:description" content="ManualLibrary — built on Replit. Update this description to reflect the app.">
    <link rel="icon" type="image/svg+xml" href="https://6587eb94-5549-497f-8f88-35c774dd0e29-00-17d6ua1vppgmj.sisko.replit.dev/favicon.svg">
    <link rel="preconnect" href="https://fonts.googleapis.com/">
    <link rel="preconnect" href="https://fonts.gstatic.com/" crossorigin="">
    <link href="./ManualLibrary_files/css2" rel="stylesheet">
  ...
  .hover\:bg-sidebar-accent\/50 {
    &:hover {
      @media (hover: hover) {
        background-color: hsl(var(--sidebar-accent));
        @supports (color: color-mix(in lab, red, red)) {
          background-color: color-mix(in oklab, hsl(var(--sidebar-accent)) 50%, transparent);
        }
      }
    }
  }
...
:root {
  ...
  --background: 48 33% 97%;
  --foreground: 163 40% 15%;
  --card: 48 33% 99%;
  --card-foreground: 163 40% 15%;
  --card-border: 48 20% 90%;
  --popover: 48 33% 99%;
  --popover-foreground: 163 40% 15%;
  --popover-border: 48 20% 90%;
  --secondary: 163 20% 90%;
  --secondary-foreground: 163 40% 25%;
  --muted: 48 20% 92%;
  --muted-foreground: 163 20% 45%;
  --accent: 48 40% 90%;
  --accent-foreground: 163 61% 41%;
  --destructive: 0 70% 50%;
  ...
  --ring: 163 61% 41%;
  --sidebar: 48 33% 95%;
  --sidebar-foreground: 163 40% 25%;
  --sidebar-border: 48 20% 86%;
  --sidebar-primary: 163 61% 41%;
  --sidebar-primary-foreground: 0 0% 100%;
  --sidebar-accent: 48 40% 90%;
  --sidebar-accent-foreground: 163 61% 41%;
...
.dark {
  ...
  --card-border: 163 30% 16%;
  --popover: 163 40% 10%;
  --popover-foreground: 48 33% 96%;
  --popover-border: 163 30% 16%;
  --primary: 163 61% 41%;
  --primary-foreground: 0 0% 100%;
  --secondary: 163 30% 18%;
  --secondary-foreground: 48 33% 90%;
  --muted: 163 30% 16%;
  --muted-foreground: 163 20% 65%;
  --accent: 163 40% 20%;
  --accent-foreground: 48 60% 90%;
  --destructive: 0 60% 40%;
  --destructive-foreground: 0 0% 100%;
  --border: 163 30% 18%;
  --input: 163 30% 18%;
  --ring: 163 61% 41%;
  --sidebar: 163 40% 9%;
  --sidebar-foreground: 48 33% 90%;
  --sidebar-border: 163 30% 16%;
  --sidebar-primary: 163 61% 41%;
  --sidebar-primary-foreground: 0 0% 100%;
  --sidebar-accent: 163 40% 20%;
  --sidebar-accent-foreground: 48 60% 90%;
}
@layer base {
  * {
    border-color: hsl(var(--border));
...
@layer properties {
  ...
  <body>
    <div id="root"><div data-replit-metadata="artifacts/library/src/components/layout.tsx:34:4" data-component-name="div" class="flex min-h-[100dvh] w-full bg-background flex-col md:flex-row"><aside data-replit-metadata="artifacts/library/src/components/layout.tsx:35:6" data-component-name="aside" class="w-full md:w-64 border-r border-sidebar-border bg-sidebar shrink-0 flex flex-col"><div data-replit-metadata="artifacts/library/src/components/layout.tsx:36:8" data-component-name="div" class="p-6 flex items-center gap-3"><div data-replit-metadata="artifacts/library/src/components/layout.tsx:37:10" data-component-name="div" class="bg-primary text-primary-foreground p-2 rounded-lg"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-book-open w-5 h-5" aria-hidden="true" data-replit-metadata="artifacts/library/src/components/layout.tsx:38:12" data-component-name="BookOpen"><path d="M12 7v14"></path><path d="M3 18a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h5a4 4 0 0 1 4 4 4 4 0 0 1 4-4h5a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1h-6a3 3 0 0 0-3 3 3 3 0 0 0-3-3z"></path></svg></div><span data-replit-metadata="artifacts/library/src/components/layout.tsx:40:10" data-component-name="span" class="font-serif text-xl font-bold text-sidebar-foreground">ManualLibrary</span></div><nav data-replit-metadata="artifacts/library/src/components/layout.tsx:42:8" data-component-name="nav" class="flex-1 px-4 flex flex-col gap-1 pb-4"><a data-replit-metadata="artifacts/library/src/components/layout.tsx:46:14" data-component-name="Link" href="https://6587eb94-5549-497f-8f88-35c774dd0e29-00-17d6ua1vppgmj.sisko.replit.dev/"><div data-replit-metadata="artifacts/library/src/components/layout.tsx:47:16" data-component-name="div" class="flex items-center gap-3 px-3 py-2.5 rounded-md cursor-pointer transition-colors bg-sidebar-accent text-sidebar-accent-foreground font-medium"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-layout-dashboard w-4 h-4" aria-hidden="true" data-replit-metadata="artifacts/library/src/components/layout.tsx:54:18" data-component-name="item.icon"><rect width="7" height="9" x="3" y="3" rx="1"></rect><rect width="7" height="5" x="14" y="3" rx="1"></rect><rect width="7" height="9" x="14" y="12" rx="1"></rect><rect width="7" height="5" x="3" y="16" rx="1"></rect></svg>Dashboard</div></a><a data-replit-metadata="artifacts/library/src/components/layout.tsx:46:14" data-component-name="Link" href="https://6587eb94-5549-497f-8f88-35c774dd0e29-00-17d6ua1vppgmj.sisko.replit.dev/books"><div data-replit-metadata="artifacts/library/src/components/layout.tsx:47:16" data-component-name="div" class="flex items-center gap-3 px-3 py-2.5 rounded-md cursor-pointer transition-colors text-sidebar-foreground hover:bg-sidebar-accent/50"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-book-open w-4 h-4" aria-hidden="true" data-replit-metadata="artifacts/library/src/components/layout.tsx:54:18" data-component-name="item.icon"><path d="M12 7v14"></path><path d="M3 18a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h5a4 4 0 0 1 4 4 4 4 0 0 1 4-4h5a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1h-6a3 3 0 0 0-3 3 3 3 0 0 0-3-3z"></path></svg>Books</div></a><a data-replit-metadata="artifacts/library/src/components/layout.tsx:46:14" data-component-name="Link" href="https://6587eb94-5549-497f-8f88-35c774dd0e29-00-17d6ua1vppgmj.sisko.replit.dev/members"><div data-replit-metadata="artifacts/library/src/components/layout.tsx:47:16" data-component-name="div" class="flex items-center gap-3 px-3 py-2.5 rounded-md cursor-pointer transition-colors text-sidebar-foreground hover:bg-sidebar-accent/50"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-users w-4 h-4" aria-hidden="true" data-replit-metadata="artifacts/library/src/components/layout.tsx:54:18" data-component-name="item.icon"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"></path><path d="M16 3.128a4 4 0 0 1 0 7.744"></path><path d="M22 21v-2a4 4 0 0 0-3-3.87"></path><circle cx="9" cy="7" r="4"></circle></svg>Members</div></a><a data-replit-metadata="artifacts/library/src/components/layout.tsx:46:14" data-component-name="Link" href="https://6587eb94-5549-497f-8f88-35c774dd0e29-00-17d6ua1vppgmj.sisko.replit.dev/categories"><div data-replit-metadata="artifacts/library/src/components/layout.tsx:47:16" data-component-name="div" class="flex items-center gap-3 px-3 py-2.5 rounded-md cursor-pointer transition-colors text-sidebar-foreground hover:bg-sidebar-accent/50"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-tags w-4 h-4" aria-hidden="true" data-replit-metadata="artifacts/library/src/components/layout.tsx:54:18" data-component-name="item.icon"><path d="M13.172 2a2 2 0 0 1 1.414.586l6.71 6.71a2.4 2.4 0 0 1 0 3.408l-4.592 4.592a2.4 2.4 0 0 1-3.408 0l-6.71-6.71A2 2 0 0 1 6 9.172V3a1 1 0 0 1 1-1z"></path><path d="M2 7v6.172a2 2 0 0 0 .586 1.414l6.71 6.71a2.4 2.4 0 0 0 3.191.193"></path><circle cx="10.5" cy="6.5" r=".5" fill="currentColor"></circle></svg>Categories</div></a><a data-replit-metadata="artifacts/library/src/components/layout.tsx:46:14" data-component-name="Link" href="https://6587eb94-5549-497f-8f88-35c774dd0e29-00-17d6ua1vppgmj.sisko.replit.dev/transactions"><div data-replit-metadata="artifacts/library/src/components/layout.tsx:47:16" data-component-name="div" class="flex items-center gap-3 px-3 py-2.5 rounded-md cursor-pointer transition-colors text-sidebar-foreground hover:bg-sidebar-accent/50"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-history w-4 h-4" aria-hidden="true" data-replit-metadata="artifacts/library/src/components/layout.tsx:54:18" data-component-name="item.icon"><path d="M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"></path><path d="M3 3v5h5"></path><path d="M12 7v5l4 2"></path></svg>Transactions</div></a></nav></aside><main data-replit-metadata="artifacts/library/src/components/layout.tsx:63:6" data-component-name="main" class="flex-1 flex flex-col min-w-0"><header data-replit-metadata="artifacts/library/src/components/layout.tsx:64:8" data-component-name="header" class="h-16 border-b border-border bg-card flex items-center justify-end px-6 shrink-0"><button data-replit-metadata="artifacts/library/src/components/layout.tsx:76:12" data-component-name="Button" class="inline-flex items-center justify-center whitespace-nowrap text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-primary text-primary-foreground hover:bg-primary/90 shadow-sm h-9 rounded-md px-3 gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-log-in w-4 h-4" aria-hidden="true" data-replit-metadata="artifacts/library/src/components/layout.tsx:77:14" data-component-name="LogIn"><path d="m10 17 5-5-5-5"></path><path d="M15 12H3"></path><path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4"></path></svg>Librarian Login</button></header><div data-replit-metadata="artifacts/library/src/components/layout.tsx:82:8" data-component-name="div" class="flex-1 overflow-auto p-6 md:p-8"><div data-replit-metadata="artifacts/library/src/components/layout.tsx:83:10" data-component-name="div" class="max-w-6xl mx-auto"><div data-replit-metadata="artifacts/library/src/pages/dashboard.tsx:31:4" data-component-name="div" class="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500"><div data-replit-metadata="artifacts/library/src/pages/dashboard.tsx:32:6" data-component-name="div" class="flex items-center justify-between"><div data-replit-metadata="artifacts/library/src/pages/dashboard.tsx:33:8" data-component-name="div"><h1 data-replit-metadata="artifacts/library/src/pages/dashboard.tsx:34:10" data-component-name="h1" class="text-3xl font-serif font-bold text-foreground mb-2">Library Overview</h1><p data-replit-metadata="artifacts/library/src/pages/dashboard.tsx:35:10" data-component-name="p" class="text-muted-foreground">Welcome to the ManualLibrary administration dashboard.</p></div><div data-replit-metadata="artifacts/library/src/pages/dashboard.tsx:37:8" data-component-name="Card" class="rounded-xl border shadow-sm overflow-hidden bg-primary text-primary-foreground border-none"><div data-replit-metadata="artifacts/library/src/pages/dashboard.tsx:38:10" data-component-name="CardContent" class="p-4 flex items-center gap-4"><div data-replit-metadata="artifacts/library/src/pages/dashboard.tsx:39:12" data-component-name="div" class="p-3 bg-white/20 rounded-full"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-trending-up w-6 h-6" aria-hidden="true" data-replit-metadata="artifacts/library/src/pages/dashboard.tsx:40:14" data-component-name="TrendingUp"><path d="M16 7h6v6"></path><path d="m22 7-8.5 8.5-5-5L2 17"></path></svg></div><div data-replit-metadata="artifacts/library/src/pages/dashboard.tsx:42:12" data-component-name="div"><p data-replit-metadata="artifacts/library/src/pages/dashboard.tsx:43:14" data-component-name="p" class="text-sm font-medium opacity-90">Total Revenue</p><p data-replit-metadata="artifacts/library/src/pages/dashboard.tsx:44:14" data-component-name="p" class="text-2xl font-bold">$0.00</p></div></div></div></div><div data-replit-metadata="artifacts/library/src/pages/dashboard.tsx:50:6" data-component-name="div" class="grid gap-6 md:grid-cols-2 lg:grid-cols-4"><div data-replit-metadata="artifacts/library/src/pages/dashboard.tsx:52:10" data-component-name="Card" class="rounded-xl border bg-card text-card-foreground shadow-sm overflow-hidden"><div data-replit-metadata="artifacts/library/src/pages/dashboard.tsx:53:12" data-component-name="CardHeader" class="space-y-1.5 p-6 flex flex-row items-center justify-between pb-2"><h3 data-replit-metadata="artifacts/library/src/pages/dashboard.tsx:54:14" data-component-name="CardTitle" class="tracking-tight text-sm font-sans font-medium text-muted-foreground">Total Books</h3><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-book-open w-4 h-4 text-blue-500" aria-hidden="true" data-replit-metadata="artifacts/library/src/pages/dashboard.tsx:57:14" data-component-name="stat.icon"><path d="M12 7v14"></path><path d="M3 18a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h5a4 4 0 0 1 4 4 4 4 0 0 1 4-4h5a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1h-6a3 3 0 0 0-3 3 3 3 0 0 0-3-3z"></path></svg></div><div data-replit-metadata="artifacts/library/src/pages/dashboard.tsx:59:12" data-component-name="CardContent" class="p-6 pt-0"><div data-replit-metadata="artifacts/library/src/pages/dashboard.tsx:60:14" data-component-name="div" class="text-3xl font-bold">10</div></div></div><div data-replit-metadata="artifacts/library/src/pages/dashboard.tsx:52:10" data-component-name="Card" class="rounded-xl border bg-card text-card-foreground shadow-sm overflow-hidden"><div data-replit-metadata="artifacts/library/src/pages/dashboard.tsx:53:12" data-component-name="CardHeader" class="space-y-1.5 p-6 flex flex-row items-center justify-between pb-2"><h3 data-replit-metadata="artifacts/library/src/pages/dashboard.tsx:54:14" data-component-name="CardTitle" class="tracking-tight text-sm font-sans font-medium text-muted-foreground">Active Members</h3><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-users w-4 h-4 text-emerald-500" aria-hidden="true" data-replit-metadata="artifacts/library/src/pages/dashboard.tsx:57:14" data-component-name="stat.icon"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"></path><path d="M16 3.128a4 4 0 0 1 0 7.744"></path><path d="M22 21v-2a4 4 0 0 0-3-3.87"></path><circle cx="9" cy="7" r="4"></circle></svg></div><div data-replit-metadata="artifacts/library/src/pages/dashboard.tsx:59:12" data-component-name="CardContent" class="p-6 pt-0"><div data-replit-metadata="artifacts/library/src/pages/dashboard.tsx:60:14" data-component-name="div" class="text-3xl font-bold">4</div></div></div><div data-replit-metadata="artifacts/library/src/pages/dashboard.tsx:52:10" data-component-name="Card" class="rounded-xl border bg-card text-card-foreground shadow-sm overflow-hidden"><div data-replit-metadata="artifacts/library/src/pages/dashboard.tsx:53:12" data-component-name="CardHeader" class="space-y-1.5 p-6 flex flex-row items-center justify-between pb-2"><h3 data-replit-metadata="artifacts/library/src/pages/dashboard.tsx:54:14" data-component-name="CardTitle" class="tracking-tight text-sm font-sans font-medium text-muted-foreground">Categories</h3><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-tags w-4 h-4 text-amber-500" aria-hidden="true" data-replit-metadata="artifacts/library/src/pages/dashboard.tsx:57:14" data-component-name="stat.icon"><path d="M13.172 2a2 2 0 0 1 1.414.586l6.71 6.71a2.4 2.4 0 0 1 0 3.408l-4.592 4.592a2.4 2.4 0 0 1-3.408 0l-6.71-6.71A2 2 0 0 1 6 9.172V3a1 1 0 0 1 1-1z"></path><path d="M2 7v6.172a2 2 0 0 0 .586 1.414l6.71 6.71a2.4 2.4 0 0 0 3.191.193"></path><circle cx="10.5" cy="6.5" r=".5" fill="currentColor"></circle></svg></div><div data-replit-metadata="artifacts/library/src/pages/dashboard.tsx:59:12" data-component-name="CardContent" class="p-6 pt-0"><div data-replit-metadata="artifacts/library/src/pages/dashboard.tsx:60:14" data-component-name="div" class="text-3xl font-bold">8</div></div></div><div data-replit-metadata="artifacts/library/src/pages/dashboard.tsx:52:10" data-component-name="Card" class="rounded-xl border bg-card text-card-foreground shadow-sm overflow-hidden"><div data-replit-metadata="artifacts/library/src/pages/dashboard.tsx:53:12" data-component-name="CardHeader" class="space-y-1.5 p-6 flex flex-row items-center justify-between pb-2"><h3 data-replit-metadata="artifacts/library/src/pages/dashboard.tsx:54:14" data-component-name="CardTitle" class="tracking-tight text-sm font-sans font-medium text-muted-foreground">Books Borrowed</h3><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-file-text w-4 h-4 text-rose-500" aria-hidden="true" data-replit-metadata="artifacts/library/src/pages/dashboard.tsx:57:14" data-component-name="stat.icon"><path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z"></path><path d="M14 2v4a2 2 0 0 0 2 2h4"></path><path d="M10 9H8"></path><path d="M16 13H8"></path><path d="M16 17H8"></path></svg></div><div data-replit-metadata="artifacts/library/src/pages/dashboard.tsx:59:12" data-component-name="CardContent" class="p-6 pt-0"><div data-replit-metadata="artifacts/library/src/pages/dashboard.tsx:60:14" data-component-name="div" class="text-3xl font-bold">0</div></div></div></div><div data-replit-metadata="artifacts/library/src/pages/dashboard.tsx:66:6" data-component-name="div" class="grid gap-6 md:grid-cols-1"><div data-replit-metadata="artifacts/library/src/pages/dashboard.tsx:67:8" data-component-name="Card" class="rounded-xl border bg-card text-card-foreground shadow-sm overflow-hidden"><div data-replit-metadata="artifacts/library/src/pages/dashboard.tsx:68:10" data-component-name="CardHeader" class="space-y-1.5 p-6 flex flex-row items-center gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-history w-5 h-5 text-muted-foreground" aria-hidden="true" data-replit-metadata="artifacts/library/src/pages/dashboard.tsx:69:12" data-component-name="History"><path d="M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"></path><path d="M3 3v5h5"></path><path d="M12 7v5l4 2"></path></svg><h3 data-replit-metadata="artifacts/library/src/pages/dashboard.tsx:70:12" data-component-name="CardTitle" class="font-serif font-semibold tracking-tight text-lg">Recent Transactions</h3></div><div data-replit-metadata="artifacts/library/src/pages/dashboard.tsx:72:10" data-component-name="CardContent" class="p-6 pt-0"><div data-replit-metadata="artifacts/library/src/pages/dashboard.tsx:105:14" data-component-name="div" class="text-center py-8 text-muted-foreground bg-muted/20 rounded-lg border border-dashed"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-history w-8 h-8 mx-auto mb-3 opacity-20" aria-hidden="true" data-replit-metadata="artifacts/library/src/pages/dashboard.tsx:106:16" data-component-name="History"><path d="M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"></path><path d="M3 3v5h5"></path><path d="M12 7v5l4 2"></path></svg><p data-replit-metadata="artifacts/library/src/pages/dashboard.tsx:107:16" data-component-name="p">No recent transactions</p></div></div></div></div></div></div></div></main></div><div role="region" aria-label="Notifications (F8)" tabindex="-1" style="pointer-events: none;"><ol tabindex="-1" data-replit-metadata="artifacts/library/src/components/ui/toaster.tsx:30:6" data-component-name="ToastViewport" class="fixed top-0 z-[100] flex max-h-screen w-full flex-col-reverse p-4 sm:bottom-0 sm:right-0 sm:top-auto sm:flex-col md:max-w-[420px]"></ol></div></div>
    <script type="module" src="./ManualLibrary_files/main.tsx"></script>
  <script src="./ManualLibrary_files/replit-pill.global.js.download" data-repl-id="6587eb94-5549-497f-8f88-35c774dd0e29"></script>

<div id="replit-pill-host"><template shadowrootmode="closed"><style>
        #replit-pill {
          position: fixed;
          bottom: 32px;
          right: 32px;
      ...
      </style><div id="replit-pill" data-state="brand"><div class="shimmer"></div><div class="badge-content"><svg width="9.33" height="14" viewBox="0 0 50 75" fill="none" class="replit-logo">
      ...
      </svg><span class="flip ready" style="width: 92px;"><span class="row in" data-key="brand" aria-hidden="false" style="">Made with Replit</span><span class="row" data-key="cta" aria-hidden="true">Build for free</span></span></div><button class="close-button" aria-label="Close"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" class="close-icon" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        <path d="M18 6 6 18"></path>
        <path d="m6 6 12 12"></path>
      </svg></button></div></template></div><div id="dse-quicksearch" style="position: fixed; z-index: 10000; display: none;">
