...
class FileManager { // এই নাম পরিবর্তন হতে পারে
    ...
    // এখানে <Generalclass>-এর জায়গায় আপনার ক্লাসের নাম হবে
    ...
    // এখানেও <Generalclass>-এর জায়গায় আপনার ক্লাসের নাম হবে
    static ArrayList<Generalclass> loadData() {//loadData change posibol
